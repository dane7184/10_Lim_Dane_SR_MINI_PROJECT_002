...
export default function ManagementProductCardComponent({ product, categories }) {
                ...
                <div className="absolute top-3 right-3 z-10">
                    ...
                    {menuOpen && (
                        <div className="absolute right-0 mt-1 w-36 rounded-xl border border-gray-100 bg-white shadow-lg z-20">
                            <button
                                className="flex items-center gap-2 w-full px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 rounded-t-xl"
